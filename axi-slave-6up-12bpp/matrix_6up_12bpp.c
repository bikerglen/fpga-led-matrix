...
#define FPGA_PANEL_ADDR_REG		(XPAR_MATRIX_6UP_12BPP_0_BASEADDR + 0x00)
#define FPGA_PANEL_DATA_REG		(XPAR_MATRIX_6UP_12BPP_0_BASEADDR + 0x04)
#define FPGA_PANEL_BUFFER_REG	(XPAR_MATRIX_6UP_12BPP_0_BASEADDR + 0x08)
#define FPGA_PANEL_DIMMER_REG	(XPAR_MATRIX_6UP_12BPP_0_BASEADDR + 0x0c)
#define FPGA_PANEL_TIMER_0_REG  (XPAR_MATRIX_6UP_12BPP_0_BASEADDR + 0x10)
...
static const uint8_t gammaLut[] = {
	...
	0x09,0x09,0x09,0x09,0x09,0x0a,0x0a,0x0a, 0x0a,0x0a,0x0a,0x0a,0x0a,0x0a,0x0b,0x0b,
	0x0b,0x0b,0x0b,0x0b,0x0b,0x0b,0x0c,0x0c, 0x0c,0x0c,0x0c,0x0c,0x0c,0x0c,0x0d,0x0d,
	0x0d,0x0d,0x0d,0x0d,0x0d,0x0e,0x0e,0x0e, 0x0e,0x0e,0x0e,0x0e,0x0f,0x0f,0x0f,0x0f
};
...
void WriteLevels (void)
{
    ...
    for (row = 0; row < DISPLAY_HEIGHT; row++) {
		Xil_Out32 (FPGA_PANEL_ADDR_REG, base + 0x80 * row);
        for (col = 0; col < DISPLAY_WIDTH; col++) {
